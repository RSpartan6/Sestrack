...
export class HomePage {
  ...
  aperturas(){
    // aperturas(fab: FabContainer){
  
      if (this.mostrarAperturas) {
        this.mostrarAperturas = false;
      }else{
        this.mostrarAperturas = true;
      }
    }
